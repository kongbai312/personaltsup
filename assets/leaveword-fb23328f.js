...
}`;be(ke);L.render=Se;L.__file="src/lib/Danmaku.vue";const Ie=n=>(pe("data-v-994b0d26"),n=n(),he(),n),Be={class:"leaveword_container"},$e=["src"],Le={class:"danmuItem_text"},Ne={class:"leaveword_box"},Ee=Ie(()=>g("div",{class:"leaveword_title"},"留言板",-1)),De={class:"leaveword_inputBox"},ze=["onKeyup"],Re=M({__name:"leaveword",setup(n){const u=c(),p=async()=>{let d=await _e();u.value=d.data,w.value.play()};$(()=>{p()});let o=c(),a=c(!1);const h=()=>{a.value=!0},C=de();let S=f(()=>C.userInfo);const I=async()=>{var d;if(!((d=C.userInfo.position)!=null&&d.ip)){let m=await ye();C.setUserPosition(m)}};$(async()=>{await I()});let w=c(),v=c();const x=()=>{var d;v.value=w.value.add({id:u.value.length+1,name:`${(d=S.value.position)==null?void 0:d.address}用户`,text:o.value,avatar:ge(2)}),o.value="",a.value=!1};return(d,m)=>(V(),H("div",Be,[re(k(L),{ref_key:"danmuRef",ref:w,danmus:k(u),"onUpdate:danmus":m[0]||(m[0]=i=>A(u)?u.value=i:null),class:"danmu_style",top:6,isSuspend:"",useSlot:""},{dm:ce(({index:i,danmu:r})=>[g("div",{class:U(["danmuItem",{danmuItem_active:i===k(v)}])},[g("img",{class:"danmuItem_img",src:r.avatar},null,8,$e),g("span",Le,W(r.name)+"："+W(r.text),1)],2)]),_:1},8,["danmus"]),g("div",Ne,[Ee,g("div",De,[T(g("input",{class:"leaveword_input",onKeyup:fe(x,["enter"]),placeholder:"留下你的足迹吧！",onFocus:h,"onUpdate:modelValue":m[1]||(m[1]=i=>A(o)?o.value=i:o=i),clearable:""},null,40,ze),[[me,k(o)]]),T(g("div",{class:"leaveword_sent",onClick:x},"发送",512),[[ve,k(a)]])])])]))}});const Pe=we(Re,[["__scopeId","data-v-994b0d26"]]);export{Pe as default};
